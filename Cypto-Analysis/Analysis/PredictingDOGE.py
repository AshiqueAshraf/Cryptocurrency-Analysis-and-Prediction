...
from PredictingDOGEOpen import PredictingDOGEOpenClass
from PredictingDOGEHigh import PredictingDOGEHighClass
from PredictingDOGELow import  PredictingDOGELowClass
from PredictingDOGEClose import PredictingDOGECloseClass
from PredictingBTCVolume import PredictingBTCVolumeClass

class PredictingDOGEClass:
    ...
    def predict(self):
        ...
        if self.currency_s=="Open":
            print("Inside if...")
            ob = PredictingDOGEOpenClass()
            ob.predict_doge_open_price(res1)
        elif self.currency_s == "High":
            ob = PredictingDOGEHighClass()
            ob.predict_doge_high_price(res1)
        elif self.currency_s == "Low":
            ob = PredictingDOGELowClass()
            ob.predict_doge_low_price(res1)
        elif self.currency_s == "Close":
            ob = PredictingDOGECloseClass()
            ob.predict_doge_close_price(res1)
