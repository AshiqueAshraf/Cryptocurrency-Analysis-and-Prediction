...
from ExploringDOGEOpen import ExploringDOGEOpenClass
from ExploringDOGEHigh import ExploringDOGEHighClass
from ExploringDOGELow import  ExploringDOGELowClass
from ExploringDOGEClose import ExploringDOGECloseClass
from ExploringDOGEVolume import ExploringDOGEVolumeClass

class ExploringDOGEClass:
    ...
    def __init__(self,top):
        ...
        top.title("EXPLORING DOGE")

        top.configure(bg="light gray")

        userid = Label(top, text="DOGE",font=("times new roman", 15, "bold"), bg="light gray").place(x=10, y=30)
    ...
    def adduser(self):
        ...
        if self.currency_s=="Open":
            ob=ExploringDOGEOpenClass()
            print("Inside if...")
            ob.check()
            ob.doge_open_price(start_obj,end_obj)
        elif  self.currency_s=="High":
            ob = ExploringDOGEHighClass()
            ob.doge_high_price(start_obj, end_obj)
        elif  self.currency_s=="Low":
            ob = ExploringDOGELowClass()
            ob.doge_low_price(start_obj, end_obj)
        elif  self.currency_s=="Close":
            ob = ExploringDOGECloseClass()
            ob.doge_close_price(start_obj, end_obj)
        elif  self.currency_s=="Volume":
            ob = ExploringDOGEVolumeClass()
            ob.doge_volume_price(start_obj, end_obj)
        else:
